...
<head>
    ...
    <link rel='stylesheet' id='contact-form-7-css'  href='{{URL::asset('event/css/contact-form-7.css')}}' type='text/css' media='all' />
    <link rel='stylesheet' id='rs-plugin-settings-css'  href='{{URL::asset('event/css/revslider.css')}}' type='text/css' media='all' />
    <link rel='stylesheet' id='woocommerce-layout-css'  href='{{URL::asset('event/css/woocommerce-layout.css')}}' type='text/css' media='all' />
    <link rel='stylesheet' id='woocommerce-smallscreen-css'  href='{{URL::asset('event/css/woocommerce-smallscreen.css')}}' type='text/css' media='only screen and (max-width: 768px)' />
    <link rel='stylesheet' id='woocommerce-general-css'  href='{{URL::asset('event/css/woocommerce.css')}}' type='text/css' media='all' />
    <link rel='stylesheet' id='bootstrap-css-css'  href='{{URL::asset('event/css/bootstrap.min.css')}}' type='text/css' media='all' />
    <link rel='stylesheet' id='awesome-css'  href='{{URL::asset('event/font/css/font-awesome.min.css')}}' type='text/css' media='all' />
    ...
    <link rel='stylesheet' id='owl.carousel-css'  href='{{URL::asset('event/css/owl.carousel.css')}}' type='text/css' media='all' />
    <link rel='stylesheet' id='owl.theme-css'  href='{{URL::asset('event/css/owl.theme.css')}}' type='text/css' media='all' />
    <link rel='stylesheet' id='flexslider-css'  href='{{URL::asset('event/css/flexslider.css')}}' type='text/css' media='screen' />
    <link rel='stylesheet' id='style-css'  href='{{URL::asset('event/style.css')}}' type='text/css' media='all' />
    <link rel='stylesheet' href='{{URL::asset('event/style-inline.css')}}' type='text/css' media='all' />
    <link rel='stylesheet' id='js_composer_front-css'  href='{{URL::asset('event/css/js_composer_front.css')}}' type='text/css' media='all' />
    <script type='text/javascript' src='{{URL::asset('event/js/jquery/jquery.js')}}' ></script>
    <script type='text/javascript' src='{{URL::asset('event/js/jquery/jquery-migrate.min.js')}}'></script>
    <script type='text/javascript' src='{{URL::asset('event/js/revslider/jquery.themepunch.tools.min.js')}}'></script>
    <script type='text/javascript' src='{{URL::asset('js/revslider/jquery.themepunch.revolution.min.js')}}'></script>
...
<body id="bd" class="home page page-id-13 page-template page-template-template-vc page-template-template-vc-php  theme-rtl wpb-js-composer js-comp-ver-4.4.2 vc_responsive tribe-theme-everline">
    <div class="livedemo">
        <h6 class="live_title">
            <em>Skill style</em>
        ...
        <div class="live-content">
            ...
            <ul>
                <li class="home1 iconclick" data-option-value="themecolor1">
                    <img src="{{URL::asset('event/images/livedemo/homecolor1.jpg')}}" alt="color 2">
                </li>
                <li class="home2 iconclick" data-option-value="themecolor2">
                    <img src="{{URL::asset('event/images/livedemo/homecolor2.jpg')}}" alt="color 2">
                </li>
                <li class="home3 iconclick" data-option-value="themecolor3">
                    <img src="{{URL::asset('event/images/livedemo/homecolor3.jpg')}}" alt="color 2">
                </li>
                <li class="home4 iconclick" data-option-value="themecolor4">
                    <img src="{{URL::asset('event/images/livedemo/homecolor4.jpg')}}" alt="color 2">
                </li>
                <li class="home5 iconclick" data-option-value="themecolor5">
                    <img src="{{URL::asset('event/images/livedemo/homecolor5.jpg')}}" alt="color 2">
                </li>
                <li class="home6 iconclick" data-option-value="themecolor6">
                    <img src="{{URL::asset('event/images/livedemo/homecolor6.jpg')}}" alt="color 2">
                </li>
                <li class="home7 iconclick" data-option-value="themecolor7">
                    <img src="{{URL::asset('event/images/livedemo/homecolor7.jpg')}}" alt="color 2">
                </li>
                <li class="home8 iconclick" data-option-value="themecolor8">
                    <img src="{{URL::asset('event/images/livedemo/homecolor8.jpg')}}" alt="color 2">
                </li>
                <li class="home9 iconclick" data-option-value="themecolor">
                    <img src="{{URL::asset('event/images/livedemo/homecolor9.jpg')}}" alt="color 2">
                </li>
            </ul>
            ...
            <div class="live-bkcontro">
                ...
                <ul class="live-patterns">
                    <li data-option-text="patterns/60degree_gray.png">
                        <img src="{{URL::asset('event/images/patterns/60degree_gray.png')}}" alt="patterns 2">
                    </li>
                    <li data-option-text="patterns/absurdidad.png">
                        <img src="{{URL::asset('event/images/patterns/absurdidad.png')}}" alt="patterns 2">
                    </li>
                    <li data-option-text="patterns/always_grey.png">
                        <img src="{{URL::asset('event/images/patterns/always_grey.png')}}" alt="patterns 2">
                    </li>
                    <li data-option-text="patterns/back_pattern.png">
                        <img src="{{URL::asset('event/images/patterns/back_pattern.png')}}" alt="patterns 2">
                    </li>
                    <li data-option-text="patterns/black_mamba.png">
                        <img src="{{URL::asset('event/images/patterns/black_mamba.png')}}" alt="patterns 2">
                    </li>
                    <li data-option-text="patterns/silver_scales.png">
                        <img src="{{URL::asset('event/images/patterns/silver_scales.png')}}" alt="patterns 2">
                    </li>
                    <li data-option-text="patterns/norwegian_rose.png">
                        <img src="{{URL::asset('event/images/patterns/norwegian_rose.png')}}" alt="patterns 2">
                    </li>
                    <li data-option-text="{{URL::asset('event/images/patterns/tiny_grid.png')}}">
                        <img src="{{URL::asset('event/images/patterns/tiny_grid.png')}}" alt="patterns 2">
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div id="tzloadding">
        <img class="loadding_img" src="{{URL::asset('event/images/loadding.GIF')}}" alt="images">
    </div>
                ...
                <div class="vc_col-sm-12 wpb_column vc_column_container ">
                    <div class="wpb_wrapper">
                                ...
                                <div class="container">
                                    ...
                                    <h3 class="tzlogo pull-left">
                                        <a href="#" title="Everline">
                                            <img src="{{URL::asset('event/images/Everline_logo.png')}}" alt="Everline">
                                        </a>
                                    </h3>
                        ...
                        <div class="tzform-search">
                            <img class="tzcontro_search" src="{{URL::asset('event/images/icon_search_delete.png')}}" alt="icon search">
                                ...
                                <div id="rev_slider_3_1" class="rev_slider fullscreenbanner">
                                    <ul>
                                        ...
                                        <li data-transition="fade" data-slotamount="7" data-masterspeed="600"  data-saveperformance="off" >
                                            <!-- MAIN IMAGE -->
                                            <img src="{{URL::asset('images/breadcrum-1.jpg')}}"  alt="everline"  data-bgposition="center top" data-kenburns="on" data-duration="9000" data-ease="Linear.easeNone" data-bgfit="100" data-bgfitend="110" data-bgpositionend="center center">
                                            <!-- LAYERS -->
                                        ...
                                        <li data-transition="fade" data-slotamount="7" data-masterspeed="600"  data-saveperformance="off" >
                                            <!-- MAIN IMAGE -->
                                            <img src="{{URL::asset('images/breadcrum-1.jpg')}}"  alt="home121"  data-bgposition="center top" data-kenburns="on" data-duration="10000" data-ease="Power0.easeIn" data-bgfit="110" data-bgfitend="100" data-bgpositionend="center center">
                                            <!-- LAYERS -->
                                            ...
                                            <div class="tp-caption customin customout"
                                                ...
                                                <img src="{{URL::asset('event/images/wrapcontent1.png')}}" alt="images">
                                            </div>
                                            ...
                                            <div class="tp-caption sfr str"
                                                 ...
                                                 data-endelementdelay="0.1"
                                                 data-endspeed="400"
                                                 data-endeasing="Power0.easeOut"><img src="{{URL::asset('event/images/line.png')}}" alt="Images">
                                            </div>
                                        ...
                                        <li data-transition="fade" data-slotamount="7" data-masterspeed="600"  data-saveperformance="off" >
                                            <!-- MAIN IMAGE -->
                                            <img src="{{URL::asset('images/breadcrum-1.jpg')}}"  alt="home212"  data-bgposition="center top" data-kenburns="on" data-duration="10000" data-ease="Power0.easeIn" data-bgfit="100" data-bgfitend="110" data-bgpositionend="center center">
                                            <!-- LAYERS -->
                        ...
                        <div class="wpb_wrapper">
                            <div class="tzintroduct">
                                ...
                                <div class="tzintroduct-img">
                                    <img src="{{URL::asset('images/app-screenshot-1.jpg')}}" class="attachment-full" alt="introduct1" />
                                </div>
                                <p>  Thank you for choosing CosmoThemes and purchasing one of our Premium WordPress Themes your choice is greatly appreciated!    </p>
                            </div>
                    ...
                    <div class="vc_col-sm-12 vc_col-lg-4 vc_col-md-4 wpb_column vc_column_container ">
                        <div class="wpb_wrapper">
                            <div class="tzintroduct">
                                <h3>BRIDE &amp; GROOM</h3>
                                <div class="tzintroduct-img">
                                    <img src="{{URL::asset('images/app-screenshot-1.jpg')}}" class="attachment-full" alt="introduct2" />
                                </div>
                                <p> Thank you for choosing CosmoThemes and purchasing one of our Premium WordPress Themes your choice is greatly appreciated!   </p>
                            </div>
                    ...
                    <div class="vc_col-sm-12 vc_col-lg-4 vc_col-md-4 wpb_column vc_column_container ">
                        <div class="wpb_wrapper">
                            <div class="tzintroduct">
                                <h3>THE PROPOSE</h3>
                                <div class="tzintroduct-img">
                                    <img src="{{URL::asset('images/app-screenshot-1.jpg')}}" class="attachment-full" alt="introduct3" />
                                </div>
                                <p>  Thank you for choosing CosmoThemes and purchasing one of our Premium WordPress Themes your choice is greatly appreciated!   </p>
                            </div>
                    ...
                    <div class="wpb_wrapper">
                        <div class="tz-portfolio-content" data-option-column="3">
                            <div id="post-50" class="post-50 portfolio type-portfolio status-publish has-post-thumbnail hentry element">
                                <div class="portfolio-item portfolio-padding">
                                    <div class="item-image">
                                        <img src="{{URL::asset('images/feature-img1.png')}}" class="attachment-full wp-post-image" alt="portfolio6" />
                                    </div>
                            ...
                            <div id="post-48" class="post-48 portfolio type-portfolio status-publish has-post-thumbnail hentry element">
                                <div class="portfolio-item portfolio-padding">
                                    <div class="item-image">
                                        <img src="{{URL::asset('images/feature-img1.png')}}" class="attachment-full wp-post-image" alt="portfolio5" />
                                    </div>
                                    <div class="tzitem-content">
                                        <i class="fa fa-heart-o tzicon"></i>
                            ...
                            <div id="post-46" class="post-46 portfolio type-portfolio status-publish has-post-thumbnail hentry element">
                                <div class="portfolio-item portfolio-padding">
                                    <div class="item-image">
                                        <img src="{{URL::asset('images/feature-img1.png')}}" class="attachment-full wp-post-image" alt="portfolio4" />
                                    </div>
                                    <div class="tzitem-content">
                                        <i class="fa fa-heart-o tzicon"></i>
                            ...
                            <div id="post-44" class="post-44 portfolio type-portfolio status-publish has-post-thumbnail hentry element">
                                <div class="portfolio-item portfolio-padding">
                                    <div class="item-image">
                                        <img src="{{URL::asset('images/feature-img1.png')}}" class="attachment-full wp-post-image" alt="portfolio3" />
                                    </div>
                                    <div class="tzitem-content">
                                        <i class="fa fa-heart-o tzicon"></i>
                            ...
                            <div id="post-42" class="post-42 portfolio type-portfolio status-publish has-post-thumbnail hentry element">
                                <div class="portfolio-item portfolio-padding">
                                    <div class="item-image">
                                        <img src="{{URL::asset('images/feature-img1.png')}}" class="attachment-full wp-post-image" alt="portfolio2" />
                                    </div>
                                    <div class="tzitem-content">
                                        <i class="fa fa-heart-o tzicon"></i>
                            ...
                            <div id="post-36" class="post-36 portfolio type-portfolio status-publish has-post-thumbnail hentry element">
                                <div class="portfolio-item portfolio-padding">
                                    <div class="item-image">
                                        <img src="{{URL::asset('images/feature-img1.png')}}" class="attachment-full wp-post-image" alt="portfolio1" />
                                    </div>
                                    <div class="tzitem-content">
                                        <i class="fa fa-heart-o tzicon"></i>
                                ...
                                <form name="" action="#" method="post" class="wpcf7-form" novalidate="novalidate">
                                    <div class="form7-wrap">
                                        <div class="form7-logo">
                                            <img class="logo_form" src="{{URL::asset('event/images/logo-contact.png')}}" alt="logo" />
                                        </div>
                                        <div class="content-form7">
                                            ...
                                            <div class="form7-item">
                                                <label>GUEST: </label><span class="wpcf7-form-control-wrap your-guest">
                                                <input type="text" name="your-guest" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" /></span>
                                            </div>
                ...
                <div class="vc_col-sm-12 wpb_column vc_column_container ">
                    <div class="wpb_wrapper">
                        <div class="tz-video">
                            ...
                            <div class="bg-video bg-video-home-rtl"></div>
                            <video class="videoID">
                                <source type="video/mp4" src="{{URL::asset('event/video/video.mp4')}}" />
                                <source type="video/ogg" src="{{URL::asset('event/video/video.ogv')}}" />
                                <source type="video/webm" src="{{URL::asset('event/video/video.webm')}}" />
                            </video>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="container-custom">
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-6">
                                        <div class="blog-item ">
                                            <div class="blog-image">
                                                <img src="{{URL::asset('images/app-screenshot-1.jpg')}}" class="attachment-medium wp-post-image" alt="bloghome4" />
                                            </div>
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="blog-item ">
                                            <div class="blog-image">
                                                <img src="{{URL::asset('images/app-screenshot-1.jpg')}}" class="attachment-medium wp-post-image" alt="bloghome3" />
                                            </div>
                                            <div class="blog-description">
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="blog-item ">
                                            <div class="blog-image">
                                                <img src="{{URL::asset('images/app-screenshot-1.jpg')}}" class="attachment-medium wp-post-image" alt="bloghome2" />
                                            </div>
                                            <div class="blog-description">
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="blog-item ">
                                            <div class="blog-image">
                                                <img src="{{URL::asset('images/app-screenshot-1.jpg')}}" class="attachment-medium wp-post-image" alt="bloghome1" />
                                            </div>
                                            <div class="blog-description">
                    ...
                    <div class="col-md-4 footerattr">
                        <aside id="widget_logo-2" class="widget_widget_logo widget">
                            <div class="tz_logo_widget">
                                <a href="#">
                                    <img src="{{URL::asset('event/images/EverlineTheme.png')}}" alt="Everline">
                                </a>
    ...
    <script type='text/javascript' src='{{URL::asset('event/js/contact-form-7/jquery.form.min.js')}}'></script>
    <script type='text/javascript' src='{{URL::asset('event/js/contact-form-7/scripts.js')}}'></script>
    <script type='text/javascript' src='{{URL::asset('event/js/woocommerce/add-to-cart.min.js')}}'></script>
    <script type='text/javascript' src='{{URL::asset('event/js/woocommerce/jquery.blockUI.min.js')}}'></script>
    <script type='text/javascript' src='{{URL::asset('event/js/woocommerce/woocommerce.min.js')}}'></script>
    <script type='text/javascript' src='{{URL::asset('event/js/woocommerce/jquery.cookie.min.js')}}'></script>
    <script type='text/javascript' src='{{URL::asset('event/js/woocommerce/cart-fragments.min.js')}}'></script>
    <script type='text/javascript' src='{{URL::asset('event/js/bootstrap.min.js')}}'></script>
    <script type='text/javascript' src='{{URL::asset('event/js/jquery.parallax-1.1.3.js')}}'></script>
    <script type='text/javascript' src='{{URL::asset('event/js/owl.carousel.js')}}'></script>
    <script type='text/javascript' src='{{URL::asset('event/js/jquery.flexslider.js')}}'></script>
    <script type='text/javascript' src='{{URL::asset('event/js/off-canvas.js')}}'></script>
    <script type='text/javascript' src='{{URL::asset('event/js/custom.js')}}'></script>
    <script type='text/javascript' src='{{URL::asset('event/js/everlinecookie.js')}}'></script>
    <script type='text/javascript' src='{{URL::asset('event/js/js_composer_front.js')}}'></script>
    <script type='text/javascript' src='{{URL::asset('event/js/countdown.js')}}'></script>
    <script type='text/javascript' src='{{URL::asset('event/js/jquery.isotope.min.js')}}'></script>
    <script type='text/javascript' src='{{URL::asset('event/js/custom-portfolio.js')}}'></script>
    <script type='text/javascript' src='{{URL::asset('event/js/jquery.jplayer.min.js')}}'></script>
    <script type='text/javascript' src='{{URL::asset('event/js/jplayer.playlist.min.js')}}'></script>
</body>
</html>